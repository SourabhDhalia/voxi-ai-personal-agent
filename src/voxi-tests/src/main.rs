...
fn print_usage() {
    eprintln!("Usage:");
    eprintln!("  voxi-tests call --method <name> [--params '<json>'] [--socket-path <path>]");
    eprintln!("  voxi-tests scenario --file <path> [--socket-path <path>]");
    eprintln!("  voxi-tests openai-oauth-regression [--socket-path <path>]");
}
