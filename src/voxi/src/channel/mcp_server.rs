...
//!
//! Implements the MCP server protocol for exposing Voxi tools
...
impl McpServer {
    ...
    fn discover_tools(&mut self) {
        ...
        // Add synthetic tool: ask_voxi
        self.tools.push(McpToolInfo {
            name: "ask_voxi".into(),
            description: "Send a natural language prompt to the Voxi AI Agent. \
        ...
        F: Fn(&str, &str) -> String,
    {
        ...
        // ask_voxi: route through agentic loop
