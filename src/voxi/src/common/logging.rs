...
//!
//! On generic platforms: stderr + optional file-based logging
//!
...
/// Initialize with the Voxi global logger.
...
impl log::Log for PlatformLogBridge {
    ...
    fn log(&self, record: &log::Record) {
        ...
        let level = match record.level() {
            log::Level::Error => voxi_core::framework::LogLevel::Error,
            log::Level::Warn => voxi_core::framework::LogLevel::Warn,
            log::Level::Info => voxi_core::framework::LogLevel::Info,
            log::Level::Debug | log::Level::Trace => voxi_core::framework::LogLevel::Debug,
        };
        ...
        let prefix = match level {
            voxi_core::framework::LogLevel::Error => "E",
            voxi_core::framework::LogLevel::Warn => "W",
            voxi_core::framework::LogLevel::Info => "I",
            voxi_core::framework::LogLevel::Debug => "D",
        };
...
impl FileLogBackend {
    ...
    fn write(msg: &str, level: voxi_core::framework::LogLevel) {
...
mod tests {
    ...
    async fn test_file_log_format_contains_pid() {
        ...
        FileLogBackend::write("test payload", voxi_core::framework::LogLevel::Info);
