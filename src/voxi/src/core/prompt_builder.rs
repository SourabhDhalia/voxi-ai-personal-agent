...
impl Default for SystemPromptBuilder {
    fn default() -> Self {
        SystemPromptBuilder {
            base_prompt: "You are Voxi, an AI assistant running inside the user's system."
                .into(),
...
mod tests {
    ...
    fn test_default_prompt_builder() {
        ...
        assert!(prompt.contains("You are Voxi"));
    ...
    fn test_tool_and_skill_injection() {
        let prompt = SystemPromptBuilder::new()
            ...
            .add_available_skill_references(vec![(
                "/opt/usr/share/voxi/docs/SKILL_BEST_PRACTICE.md".into(),
