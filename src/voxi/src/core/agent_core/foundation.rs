...
fn collect_tool_roots(paths: &voxi_core::framework::paths::PlatformPaths) -> Vec<String> {
...
fn collect_skill_roots(paths: &voxi_core::framework::paths::PlatformPaths) -> Vec<String> {
    let mut roots = vec![
...
fn list_known_sessions(paths: &voxi_core::framework::paths::PlatformPaths) -> Vec<String> {
