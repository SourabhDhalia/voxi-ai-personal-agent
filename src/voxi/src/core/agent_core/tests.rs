...
mod tests {
    use super::{
        ...
        is_simple_file_management_request,
        ...
        parse_shell_like_args, parse_tool_uri, paragraph_count,
        ...
        role_relevance_score, score_tool_search_match,
  ...
  {"name":"CES 2026","date":"2026-01-06","location":"Las Vegas","website":"https://www.ces.tech/"}
    ...
    use super::{
        ...
        sanitize_generated_code_name, persist_generated_code_copy,
    };
    ...
    fn generated_code_script_path_uses_codes_directory() {
        let base_dir = std::path::Path::new("/home/owner/.voxi");
