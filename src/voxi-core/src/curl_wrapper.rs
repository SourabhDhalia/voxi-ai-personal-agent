//! HTTP helper — curl-like C API backed by Rust `reqwest`.
//!
//! Provides `voxi_curl_*` functions that external plugins
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_create(out: *mut *mut libc::c_void) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_destroy(h: *mut libc::c_void) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_set_url(h: *mut libc::c_void, url: *const c_char) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_add_header(h: *mut libc::c_void, header: *const c_char) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_set_post_data(h: *mut libc::c_void, data: *const c_char) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_set_method_get(h: *mut libc::c_void) -> i32 {
    if h.is_null() { return EINVAL; }
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_set_timeout(h: *mut libc::c_void, connect: libc::c_long, request: libc::c_long) -> i32 {
    if h.is_null() { return EINVAL; }
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_set_write_callback(
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_perform(h: *mut libc::c_void) -> i32 {
    if h.is_null() { return EINVAL; }
    let inner = &mut *(h as *mut CurlInner);
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_get_response_code(h: *mut libc::c_void, out: *mut libc::c_long) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn voxi_curl_get_error_message(h: *mut libc::c_void) -> *const c_char {
    if h.is_null() {
